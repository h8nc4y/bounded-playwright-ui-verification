...
2026-07-01 の PR #11 後 current-state sync branch で下記を追加実行した（`AGENTS.md` §6 と同形）。
...
- 生きた候補一覧は `AGENTS.md` §5 と `TASKS_BACKLOG.md` を参照。2026-07-01 時点で T-001〜T-013 はすべて `done`。
